      ...
      <section className="w-full py-6 md:py-8 bg-gradient-to-b from-[#FFC8C8]/50 to-white">
        <div className="container mx-auto text-center px-4">
          <h2 className="text-4xl md:text-5xl font-extrabold text-secondary uppercase tracking-tight max-w-4xl mx-auto">
            Cansada das restrições alimentares e de se preocupar com dinheiro?
          </h2>
      ...
      <div className="transition-all duration-700 ease-in-out">
          <section className="w-full py-12 md:py-20 bg-gradient-to-b from-white to-[#FFC8C8]/50">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-2xl md:text-4xl font-extrabold text-secondary">Sua chance de resolver dois problemas de uma vez!</h2>
                ...
                <div className="max-w-4xl mx-auto text-left space-y-8">
                    <Card className="bg-white shadow-lg border-primary/20">
                        ...
                        <CardContent className="space-y-4 text-base md:text-lg text-gray-700">
                           <p className="flex items-start gap-2"><CheckCircle className="text-primary mt-1 h-5 w-5 shrink-0" /> <span><strong>Fim das Restrições:</strong> Chega de sofrer! Coma doces deliciosos sem se preocupar com lactose, glúten ou açúcar.</span></p>
                           <p className="flex items-start gap-2"><CheckCircle className="text-primary mt-1 h-5 w-5 shrink-0" /> <span><strong>Dinheiro no Bolso:</strong> Transforme sua paixão em lucro! Um caminho testado para fazer uma renda extra vendendo doces irresistíveis.</span></p>
